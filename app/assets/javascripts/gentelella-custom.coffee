...
init_sidebar = ->
  ...
  console.log "jkhgfdhjklhgf"

  setContentHeight = ->
    # reset height
    $('.right_col').css 'min-height', $(window).height()
    bodyHeight = $('body').outerHeight()
    footerHeight = if $('body').hasClass('footer_fixed') then -10 else $('footer').height()
  ...
  $('#sidebar-menu').find('a').on 'click', (ev) ->
...
init_starrr = ->
  ...
  $('.stars').on 'starrr:change', (e, value) ->
    ...
    return
  $('.stars-existing').on 'starrr:change', (e, value) ->
...
init_gauge = ->
  ...
  if $('#chart_gauge_01').length
    chart_gauge_01_elem = document.getElementById('chart_gauge_01')
  ...
  if $('#chart_gauge_02').length
    chart_gauge_02_elem = document.getElementById('chart_gauge_02')
    chart_gauge_02 = new Gauge(chart_gauge_02_elem).setOptions(chart_gauge_settings)
...
init_autocomplete = ->
  ...
  countriesArray = $.map(countries, (value, key) ->
    {
      value: value
      data: key
    }
...
init_daterangepicker_right = ->
  ...
  $('#reportrange_right').on 'hide.daterangepicker', ->
    console.log 'hide event fired'
    return
  $('#reportrange_right').on 'apply.daterangepicker', (ev, picker) ->
    console.log 'apply event fired, start/end dates are ' + picker.startDate.format('MMMM D, YYYY') + ' to ' + picker.endDate.format('MMMM D, YYYY')
    return
  $('#reportrange_right').on 'cancel.daterangepicker', (ev, picker) ->
    console.log 'cancel event fired'
    return
  $('#options1').click ->
...
init_daterangepicker_reservation = ->
  ...
  $('#reservation').daterangepicker null, (start, end, label) ->
    console.log start.toISOString(), end.toISOString(), label
    return
...
init_CustomNotification = ->
  ...
  TabbedNotification = (options) ->
    message = '<div id=\'ntf' + cnt + '\' class=\'text alert-' + options.type + '\' style=\'display:none\'><h2><i class=\'fa fa-bell\'></i> ' + options.title + '</h2><div class=\'close\'><a href=\'javascript:;\' class=\'notification_close\'><i class=\'fa fa-close\'></i></a></div><p>' + options.text + '</p></div>'
  ...
  CustomTabs()
  tabid = idname = ''
  $(document).on 'click', '.notification_close', (e) ->
...
init_charts = ->
  ...
  if $('#canvas_line').length
    canvas_line_00 = new Chart(document.getElementById('canvas_line'),
      type: 'line'
      data:
        labels: [
          'January'
  ...
  if $('#canvas_line1').length
    canvas_line_01 = new Chart(document.getElementById('canvas_line1'),
      type: 'line'
      data:
        labels: [
          'January'
  ...
  if $('#canvas_line2').length
    canvas_line_02 = new Chart(document.getElementById('canvas_line2'),
      type: 'line'
      data:
        labels: [
          'January'
  ...
  if $('#canvas_line3').length
    canvas_line_03 = new Chart(document.getElementById('canvas_line3'),
      type: 'line'
      data:
        labels: [
          'January'
  ...
  if $('#canvas_line4').length
    canvas_line_04 = new Chart(document.getElementById('canvas_line4'),
      type: 'line'
      data:
        labels: [
          'January'
  ...
  # PolarArea chart
  if $('#polarArea').length
    ctx = document.getElementById('polarArea')
    data =
      datasets: [ {
        data: [
          120
...
init_echarts = ->
  ...
  if $('#echart_sonar').length
    echartRadar = echarts.init(document.getElementById('echart_sonar'), theme)
  ...
  if $('#echart_pyramid').length
    echartFunnel = echarts.init(document.getElementById('echart_pyramid'), theme)
  ...
  if $('#echart_gauge').length
    echartGauge = echarts.init(document.getElementById('echart_gauge'), theme)
  ...
  if $('#echart_scatter').length
    echartScatter = echarts.init(document.getElementById('echart_scatter'), theme)
  ...
  if $('#echart_bar_horizontal').length
    echartBar = echarts.init(document.getElementById('echart_bar_horizontal'), theme)
    echartBar.setOption
      title:
        text: 'Bar Graph'
  ...
  if $('#echart_pie2').length
    echartPieCollapse = echarts.init(document.getElementById('echart_pie2'), theme)
  ...
  if $('#echart_mini_pie').length
    echartMiniPie = echarts.init(document.getElementById('echart_mini_pie'), theme)
  ...
  if $('#echart_world_map').length
    echartMap = echarts.init(document.getElementById('echart_world_map'), theme)
    echartMap.setOption
      title:

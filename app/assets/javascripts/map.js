/**
 * Created by M Shoaib Masood on 11/19/2017.
 */

$(document).ready(function() {
    $(".UTSplacepicker").placepicker();
});
    ...
    function PlacePicker(element, options) {
        ...
        function template() {
            var templateString =
                ...
                "<button type=\"button\" data-toggle=\"collapse\" href=\"#" + options.mapContainerId + "\" class=\"btn btn-default form-control\">" +
                "<i class=\"fa fa-map-marker fa-wa\"></i>" +
                "</button>" +
                "</span>" +
                "</div>";
        ...
        function setPlace(place, updateMap) {
            ...
            //alert(pos.lat());
            $('#latitude').prop("value", pos.lat());
            $('#longitude').prop("value", pos.lng());
